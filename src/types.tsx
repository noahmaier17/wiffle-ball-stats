...
export const rowToLogEntry = (row: any, findPlayer: (id: number) => Player): GameLogEntry => {
    switch (row.type) {
        case 'atbat': {
            ...
            if (!ab) return { type: 'additional_information', info: `Missing at bat`, typeOfInfo: 'gamestate_reply_issue' };
            return {
                type: 'atbat',
                logId: row.id,
        ...
        case 'pitching_change': {
            ...
            if (!pc) return { type: 'additional_information', info: `Missing pitching change`, typeOfInfo: 'gamestate_reply_issue' };
            return {
                type: 'pitching_change',
        ...
        case 'additional_information': {
            ...
            if (!ai) return { type: 'additional_information', info: `Missing additional info`, typeOfInfo: 'gamestate_reply_issue' };
            return {
                type: 'additional_information',
                info: ai.info,
        ...
        case 'edit_gamestate': {
            ...
            if (!eg) return { type: 'additional_information', info: `Missing edit gamestate log`, typeOfInfo: 'gamestate_reply_issue' };
            return {
                type: 'edit_gamestate',
